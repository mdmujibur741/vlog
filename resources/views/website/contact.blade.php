        ...
        <div class="row">
            ...
            <form action="{{route('website.message')}}" method="post" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="subject" id="subject" name="subject" class="form-control" placeholder="Subject" value="{{old('subject')}}">
                </div>
              </div>
          ...
          <div class="col-md-5">
            ...
            <div class="p-4 mb-3 bg-white">
             @if($setting->address==!null) <p class="mb-0 font-weight-bold">Address</p>
              <p class="mb-4"> <a href="">{{$setting->address}}</a> </p> @endif

             @if($setting->phone==!null) <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#"> {{$setting->phone}} </a></p> @endif

             @if($setting->email==!null) <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#"> {{$setting->email}} </a></p> @endif
